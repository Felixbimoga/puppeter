...
async function createPDF(chartDOMBase64) {
  const htmlPDF = new PuppeteerHTMLPDF({ headless: true });
  const options = {
    format: 'A4',
    landscape: true,
    args: [
  ...
  try {
    ...
    slide10_1Base64 = await loadImage('slide10_1.jpg', 'slide10_1Base64');
    slide10_2Base64 = await loadImage('slide10_2.jpg', 'slide10_2Base64');
    ...
    slide13Base64 = await loadImage('slide13.jpg', 'slide13Base64');
